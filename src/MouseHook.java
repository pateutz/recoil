...
public final class MouseHook {
    ...
    /**
     * Firearm 0 is akm 1 is m416 2 is scar
     */
    static int weapon = 0;
    ...
    static double[][] m4 = {{21,21,21,21,21,21,21,21,21,23,23,24,23,24,25,25,26,27,27,32,31,31,31,31,31,31,31,32,32,32,35,35,35,35,35,35,35,35,35,35,35},
    ...
    static double[][] scar = {{20,21,22,21,22,22,23,22,23,23,24,24,25,25,25,25,26,27,28,29,30,32,34,34,35,34,35,34,35,34,35,34,34,34,34,34,35,35,35,35,35,35,35,35,35,35},
            {86.7,86.7,86.7,86.7,86.7,86.7,86.7,150,150,150,150,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7,96.7},
            {96}};
    ...
    /**
     * Sensitivity conversion, the default is 50
     *
    ...
    /**
     * Overwrite the left button down the callback function
     *
     * @return
     */
    ...
    /**
     * Overwrite the left button to release the callback function
     *
     * @return
     */
